                    ...
                    <form action="ManterPais.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="populacao" id="populacao" maxlength="15" placeholder="opcional; celular com ddd no formato (99) 99999-9999" value="${pais.populacao }">
                            </div>
